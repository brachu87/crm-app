        ...
        <>
          <div className="card">
            ...
            <p style={{ fontSize: 13, color: 'var(--ink-soft)', marginBottom: 12 }}>
              Conectá tu Mercado Pago para que tus socios paguen la cuota desde el portal del socio. El dinero va directo a tu cuenta de Mercado Pago.
            ...
            <div className="field">
              ...
              <span style={{ fontSize: 12, color: 'var(--ink-soft)' }}>Lo obtenés en mercadopago.com.ar → Tu negocio → Credenciales → Credenciales de producción → Access Token.</span>
            </div>
            ...
            <p style={{ fontSize: 12, color: 'var(--ink-soft)', marginTop: 14, borderTop: '1px solid var(--border)', paddingTop: 12 }}>
              ℹ️ Cuando esté conectado, en el portal del socio aparece el botón "Pagar" en cada cuota pendiente. El pago se registra automáticamente en Cobranza y Caja.
            </p>
          </div>
        </>
      )}
