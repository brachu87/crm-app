...
const SECTION_INTRO = {
  ...
  '/ordenes': { key: 'ordenes', title: 'Órdenes de trabajo', text: 'Convertí un presupuesto aceptado en una orden, asignala a un empleado y seguí su estado hasta terminarla.' },
