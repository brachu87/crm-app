...
const entityNotesRoutes = require('./routes/entity-notes');
...
app.use('/api/entity-notes', entityNotesRoutes);
...
startBackupCron(); // Backup diario de clientes por email (por negocio, según su hora)
