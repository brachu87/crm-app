...
cd /d C:\crm-app
echo ============================================
echo   Zentric - Fix fotos/logo rotos
echo ============================================
echo.
pause
...
git apply zentric-fix-fotos.patch
if errorlevel 1 ( echo ERROR al aplicar. & pause & exit /b 1 )
echo [3/4] Commit...
git add -A
git commit -m "fix: quitar /api duplicado en AuthImage (fotos y logo rotos)"
echo [4/4] Subiendo...
git push origin main
if errorlevel 1 ( echo ERROR al subir. Entra como brachu87. & pause & exit /b 1 )
del /f /q zentric-fix-fotos.patch 2>nul
echo.
echo ============================================
