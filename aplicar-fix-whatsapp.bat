...
cd /d C:\crm-app
echo ============================================
echo   Zentric - Fix WhatsApp (conexion + sesion)
echo ============================================
echo.
pause
...
git apply zentric-fix-whatsapp.patch
if errorlevel 1 ( echo ERROR al aplicar. & pause & exit /b 1 )
echo [3/4] Commit...
git add -A
git commit -m "fix(whatsapp): sesion persistente en /data + destrabar loop de reconexion"
echo [4/4] Subiendo...
git push origin main
if errorlevel 1 ( echo ERROR al subir. Entra como brachu87. & pause & exit /b 1 )
del /f /q zentric-fix-whatsapp.patch 2>nul
echo.
echo ============================================
echo   LISTO. Railway buildea en 1-2 min.
echo   Despues: Ajustes - WhatsApp - escanea el QR.
echo ============================================
pause
