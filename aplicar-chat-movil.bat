...
cd /d C:\crm-app
echo ============================================
echo   Zentric - Ocultar chat de soporte en movil
echo ============================================
echo.
pause
...
git apply zentric-chat-movil.patch
if errorlevel 1 ( echo ERROR al aplicar. & pause & exit /b 1 )
echo [3/4] Commit...
git add -A
git commit -m "responsive: ocultar chat de soporte en movil (tapaba botones de guardar)"
echo [4/4] Subiendo...
git push origin main
if errorlevel 1 ( echo ERROR al subir. Entra como brachu87. & pause & exit /b 1 )
del /f /q zentric-chat-movil.patch 2>nul
echo.
echo ============================================
